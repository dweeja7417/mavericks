<!-- Author : Akanksha,Adrija
	Purpose :  -->

<%@ page language="java" import="java.util.List,com.code.bean.Bug,java.util.ArrayList,com.code.bean.Project" contentType="text/html; charset=ISO-8859-1"
	...
	<div class="row justify-content-center">
		<div class="col-9">
			...
			if(project!=null){  %>
				...
				<%}else { %>
					<h5>You are not assigned to a Project.</h5>
				<% } %>	
				</table>
		</div>
	</div>
